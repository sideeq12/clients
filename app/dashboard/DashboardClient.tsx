...
import { Profile, Company, Enquiry, Deadline, Case } from "@/lib/supabase/types";
...
export function DashboardClient({ profile, companies, enquiries, deadlines, cases, stats }: DashboardClientProps) {
